...
async function fetchpaymentDetails(headers) {
    const apiUrl = "http://192.168.0.121:8003/api/method/medkado.medkado.doctype.medkado_admin_settings.medkado_admin_settings.payment_details_of_user_dashboard";
